    ...
    return(
        ...
        <div id="home" className="slider-area position-relative">
                        ...
                        <div className="row">
                            <div className="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                                <div className="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay="0.1s">with IK Fitness</span>
            ...
            <div className="video-icon">
                <a className="popup-video btn-icon" href="https://www.youtube.com/@ikfitnessgym545"><i className="fas fa-play"></i></a>
            </div>
        </div></>
